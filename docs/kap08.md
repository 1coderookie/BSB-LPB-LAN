...
-   **Zusätzlich die eigene oder die Zieladresse mittels URL-Befehl
    ...
    Leerwerte bei den Adressen belassen den bisherigen Wert (=
    Adresse).\
...
-   **24h-Durchschnittswerte von ausgewählten Parametern anzeigen:**
    ...
    *BSB\_lan\_config.h* in der Variable *avg\_parameters*.\
...
-   **Darstellung des Logfiles:**
    ...
    für die erste Benutzung empfohlen, bevor das Loggen startet).
...
*Beispiel:* Der URL-Befehl für den HK1, um eine Raumtemperatur von
...
-   **Abfragen und Setzen von Parametern per HTTP POST:**
    ...
    http://\<IP-Adresse\>/JQ\
    Senden: \"Parameter\"\
    Empfangen: \"Parameter\", \"Value\", \"Unit\", \"DataType\" (0 =
...
5024 Trinkwasserspeicher - TWW Schaltdifferenz 1 ein: error 7 (parameter
not supported)\
...
8314 Diagnose Erzeuger - Kesselrücklauftemperatur Ist: error 7
