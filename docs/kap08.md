...
|  **/A=0**                 | **24h-Durchschnittswertberechnung temporär deaktivieren.** <br /> Nach einem Reset/Neustart des Arduino wird die Berechnung gemäß den Einstellungen in der Datei *BSB_lan_config.h* wieder gestartet.  
