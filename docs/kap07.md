...
Bei einer Doppelbelegung kann es zu Fehlfunktionen bis hin zu Schäden an der Hardware kommen! Die in der Datei *BSB_LAN_config.h* voreingestellten Pins werden u.U. bei deinem spezifischen Board bereits anderweitig verwendet, also prüfe die Belegung vor der Aktivierung/Nutzung! |  
