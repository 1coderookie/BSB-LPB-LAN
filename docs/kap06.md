...
| Werden die Raumtemperaturen von mehreren Räumen erfasst (bspw. mittels entspr. HK-Thermostate oder Raumtemperaturfühler und einer SmartHome-Software), kann es vorteilhaft sein, daraus eine gemittelte Ist- und Soll-Temperatur zu errechnen und an den Wärmeerzeuger zu übermitteln. Ein Beispiel hierfür hat FHEM-Forumsuser "freetz" in folgendem Thread zur Verfügung gestellt: (https://forum.fhem.de/index.php/topic,60900.0.html)[https://forum.fhem.de/index.php/topic,60900.0.html] - vielen Dank dafür! |    
