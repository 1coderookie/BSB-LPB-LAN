...
|:-------------:|:-------------:|:-------------------------------------------:|
| Advanced options | Aus | Anzeige der erweiterten Einstellungen von BSB-LAN (Aus/Ein). Für Zugriff aus sämtliche Einstellungsmöglichkeiten von BSB-LAN muss "Ein" ausgewählt (und anschließend unten auf "Parameter speichern" geklickt) werden. |
