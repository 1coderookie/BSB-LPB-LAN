...
erfolgreich mit dem BSB-LAN Setup betrieben werden (können).
...
- der verwendetenen Anschlussart (BSB/LPB/PPS),  
- der [Ausgabe der Parameterabfrage `http://<IP-Adresse>/Q` (via Adapter!)](kap03.md#33-überprüfen-auf-nicht-freigegebene-reglerspezifische-command-ids) sowie
- des verwendeten BSB-LAN Setups (Plattform & Adapterversion) zu melden.  
Dazu kann entweder der entspr. [Thread im FHEM-Forum](https://forum.fhem.de/index.php/topic,29762.0.html) genutzt oder eine Email an Frederik (bsb (ät) code-it.de) oder mich (Ulf, adapter (ät) quantentunnel.de) geschickt werden.  
Danke!
