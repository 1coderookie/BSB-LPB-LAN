...
[**6. BSB-LAN: Spezialfunktionen**](kap09.md)  
   * [6.1 Loggen von Daten](kap09.md#915-loggen-von-daten)  
   * [6.2 IPWE-Erweiterung](kap09.md#96-ipwe-erweiterung)  
   * [6.3 Raumtemperatur übermitteln](kap09.md#91-raumtemperatur-übermitteln)  
   * [6.4 Präsenztaste simulieren](kap09.md#92-präsenztaste-simulieren)  
   * [6.5 Manuellen TWW-Push ausführen](kap09.md#93-manuellen-tww-push-ausführen)  
   * [6.6 Datum, Uhrzeit und Zeitprogramme verändern](kap09.md#97-datum-uhrzeit-und-zeitprogramme-verändern)  
   * [6.7 Übermitteln einer alternativen Außentemperatur](kap09.md#98-übermitteln-einer-alternativen-außentemperatur)  
   * [6.8 Eigenen Code in BSB-LAN einbinden](kap09.md#99-eigenen-code-in-bsb-lan-einbinden)  
   * [6.9 Verwenden der Webserver-Funktion](kap09.md#910-verwenden-der-webserver-funktion)  
   * [6.10 Benutzen des alternativen AJAX Webinterface](kap09.md#911-benutzen-des-alternativen-ajax-webinterface)  
   * [6.11 Raumgerät-Emulation](kap09.md#913-raumgerät-emulation)  
   * [6.12 EEPROM-Löschung mittels Pinkontakten](kap09.md#914-eeprom-löschung-mittels-pinkontakten)  
